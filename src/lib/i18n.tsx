...
const de = {
  ...
  "settings.importHelp": "Das JSON-Backup enthält Verlauf, pausierte Sitzungen mit Entwürfen und Timer, Masterplan, Alternativen, Sprache und Einheiteneinstellungen.",
...
const en: Record<keyof typeof de, string> = {
  ...
  "settings.importHelp": "The JSON backup includes history, paused sessions with drafts and timer, master plan, alternatives, language and unit settings.",
