...
const de = {
  ...
  "settings.importHelp": "Das JSON-Backup enthält Trainingsverlauf, Masterplan, Übungsreihenfolge, hinzugefügte oder entfernte Slots und dauerhaft gewählte Alternativen.",
...
const en: Record<keyof typeof de, string> = {
  ...
  "settings.importHelp": "The JSON backup includes workout history, master plan, exercise order, added or removed slots, and permanently selected alternatives.",
