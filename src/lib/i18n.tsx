...
const de = {
  ...
  "status.offlineReady": "Offline bereit",
  "status.online": "Online · Offline-Modus wird vorbereitet",
  "status.update": "Update verfügbar · neu laden",
  "common.day": "Tag",
  "common.of": "von",
  "common.set": "Satz",
  "common.sets": "Sätze",
  "common.setSingular": "Satz",
  ...
  "storage.title": "Lokale Daten konnten nicht geladen werden",
  "storage.help": "Prüfe den verfügbaren Gerätespeicher oder die Browser-Einstellungen. Deine bestehenden Daten werden nicht überschrieben.",
  "storage.retry": "Erneut versuchen",
  "storage.saveError": "Änderung konnte nicht gespeichert werden.",
  "today.eyebrow": "Heute",
  ...
  "today.paused": "Pausiertes Training",
  "today.resume": "Training fortsetzen",
  "today.resumeHelp": "Dein Timer, deine Sätze und Eingaben bleiben gespeichert.",
  "today.discard": "Training verwerfen",
  "today.resumeFirst": "Laufendes Training fortsetzen",
  "today.confirmDiscard": "Das pausierte Training wirklich verwerfen? Bereits protokollierte Sätze bleiben nicht im Verlauf.",
  "plan.eyebrow": "Trainingsplan",
  "plan.title": "Die A/B/C-Rotation",
  "plan.subtitle": "54 Arbeitssätze, flexibel über die Woche verteilt.",
  "plan.subtitleDynamic": "{sets} Arbeitssätze, flexibel über die Woche verteilt.",
  ...
  "workout.completeSetNumber": "Satz {set} abschließen",
  "workout.currentSet": "Aktueller Satz",
  "workout.setProgress": "Satzfortschritt",
  "workout.todaySets": "Heutige Sätze",
  "workout.setsCompleted": "{completed} von {total} erledigt",
  "workout.previous": "Vorher",
  "workout.today": "Heute",
  ...
  "workout.confirmDiscardEmpty": "Es wurde noch kein Satz protokolliert. Training verwerfen?",
  "workout.confirmFinishPartial": "Training mit {sets} protokollierten Sätzen vorzeitig abschließen und für die Rotation werten?",
  "workout.replaceLocked": "Nach dem ersten protokollierten Satz kann die Übung nicht mehr ersetzt werden. Lösche die Sätze zuerst oder wechsle zu einer anderen Übung.",
  "workout.replaceLockedShort": "Tausch nach Satz gesperrt",
  "workout.saving": "Wird gespeichert …",
  "workout.editSet": "Satz bearbeiten",
  "workout.deleteSet": "Satz löschen",
  "workout.correctSet": "Korrektur",
  "workout.undoHelp": "Letzte Satzänderung gespeichert.",
  "workout.timerDone": "Pause beendet · bereit für den nächsten Satz",
  "history.eyebrow": "Verlauf",
  "history.title": "Deine Trainingshistorie",
  "history.subtitle": "Alle Einheiten bleiben nachvollziehbar und können bei Eingabefehlern korrigiert werden.",
  ...
  "stats.subtitle": "Progression, Trainingskonstanz und Muskelbalance auf einen Blick.",
  "stats.open": "Fortschritt ansehen",
  "stats.range": "Zeitraum",
  "stats.eightWeeks": "8 Wochen",
  "stats.sixMonths": "6 Monate",
  "stats.all": "Gesamt",
  "stats.sessions": "Einheiten",
  "stats.sets": "Arbeitssätze",
  "stats.perSession": "pro Einheit",
  "stats.externalVolume": "Externes Volumen",
  "stats.exerciseTrend": "Übungstrend",
  "stats.empty": "Noch keine Daten",
  "stats.emptyHelp": "Nach deinem ersten Training werden hier Trends und Balance sichtbar.",
  "stats.consistency": "Konstanz",
  "stats.weeklySets": "Arbeitssätze pro Woche",
  "stats.monthlySets": "Arbeitssätze pro Monat",
  "stats.setChartLabel": "Verlauf der protokollierten Arbeitssätze",
  "stats.progression": "Progression",
  "stats.byExercise": "Nach Übung",
  "stats.chooseExercise": "Übung für Progressionsdiagramm wählen",
  "stats.exerciseChartLabel": "Leistungsentwicklung der gewählten Übung",
  "stats.noExerciseData": "Für diese Übung liegen im Zeitraum keine Daten vor.",
  "stats.e1rmHelp": "Bei externen Lasten zeigt die Kurve das geschätzte 1RM, bei Körpergewicht die beste Wiederholungszahl.",
  "stats.balance": "Balance",
  "stats.movementBalance": "Bewegungsmuster",
  "stats.balanceHelp": "Vergleicht deine Arbeitssätze nach Push, Pull, Beinen, Core und Isolation.",
  "stats.distribution": "Verteilung",
  "stats.byMuscle": "Arbeitssätze nach Muskelgruppe",
  "settings.eyebrow": "Mehr",
  "settings.title": "Einstellungen & Daten",
  "settings.subtitle": "Ohne Konto, Tracking oder Cloud-Speicher. Alle Trainingsdaten bleiben lokal in diesem Browser.",
  "settings.training": "Training",
  "settings.units": "Einheitensystem",
  "settings.unitsHelp": "Anzeige für externe Lasten",
  "settings.weightStep": "Gewichtsschritte",
  "settings.weightStepHelp": "Schrittweite der Plus- und Minus-Tasten",
  "settings.timer": "Pausentimer",
  "settings.timerHelp": "Je Übung aus dem Trainingsplan",
  "settings.source": "Quelle des Trainingskonzepts",
  "settings.sourceDescription": "Originalvideo von Dennis Ratano · konzeptionelle Grundlage dieser Trainingsmethode",
  "settings.sourceLink": "Auf YouTube ansehen",
  "settings.data": "Daten",
  "settings.saved": "Einheiten lokal gespeichert",
  "settings.deviceOnly": "IndexedDB · nur in diesem Browser",
  "settings.safe": "Nur lokal",
  "settings.exportJson": "JSON exportieren",
  "settings.importJson": "JSON importieren",
  "settings.exportCsv": "CSV exportieren",
  "settings.importHelp": "Gerätewechsel: Hier JSON exportieren und im neuen Browser importieren. Das Backup enthält Verlauf, pausierte Sitzungen mit Entwürfen und Timer, Masterplan, Alternativen, Sprache und Einheiteneinstellungen.",
  "settings.confirmImport": "Das Backup ersetzt alle aktuellen lokalen Trainings- und Plandaten. Fortfahren?",
  "settings.importSuccess": "Backup vollständig wiederhergestellt.",
  "settings.importError": "Das Backup ist ungültig oder konnte nicht gelesen werden.",
...
const en: Record<keyof typeof de, string> = {
  ...
  "status.online": "Online · preparing offline mode",
  "status.update": "Update available · reload",
  "common.day": "Day",
  "common.of": "of",
  "common.set": "Set",
  "common.sets": "sets",
  "common.setSingular": "set",
  ...
  "common.save": "Save",
  "common.undo": "Undo",
  "storage.title": "Local data could not be loaded",
  "storage.help": "Check available device storage or browser settings. Existing data will not be overwritten.",
  "storage.retry": "Try again",
  "storage.saveError": "The change could not be saved.",
  "today.eyebrow": "Today",
  ...
  "today.paused": "Paused workout",
  "today.resume": "Resume workout",
  "today.resumeHelp": "Your timer, sets, and inputs remain saved.",
  "today.discard": "Discard workout",
  "today.resumeFirst": "Resume current workout",
  "today.confirmDiscard": "Discard the paused workout? Logged sets will not be added to your history.",
  ...
  "plan.subtitleDynamic": "{sets} working sets, flexibly distributed across the week.",
  ...
  "workout.completeSetNumber": "Complete set {set}",
  "workout.currentSet": "Current set",
  "workout.setProgress": "Set progress",
  "workout.todaySets": "Today's sets",
  "workout.setsCompleted": "{completed} of {total} complete",
  ...
  "workout.confirmDiscardEmpty": "No set has been logged yet. Discard this workout?",
  "workout.confirmFinishPartial": "Finish early with {sets} logged sets and count it in the rotation?",
  "workout.replaceLocked": "An exercise cannot be replaced after its first logged set. Delete the sets first or switch to another exercise.",
  "workout.replaceLockedShort": "Swap locked after set",
  "workout.saving": "Saving …",
  "workout.editSet": "Edit set",
  "workout.deleteSet": "Delete set",
  "workout.correctSet": "Correction",
  "workout.undoHelp": "Latest set change saved.",
  "workout.timerDone": "Rest complete · ready for the next set",
  "history.eyebrow": "History",
  "history.title": "Your training history",
  "history.subtitle": "Every session stays traceable and can be corrected after an input error.",
  ...
  "stats.subtitle": "Progression, training consistency and muscular balance at a glance.",
  "stats.open": "View progress",
  "stats.range": "Time range",
  "stats.eightWeeks": "8 weeks",
  "stats.sixMonths": "6 months",
  "stats.all": "All time",
  "stats.sessions": "Sessions",
  "stats.sets": "Working sets",
  "stats.perSession": "per session",
  "stats.externalVolume": "External volume",
  "stats.exerciseTrend": "Exercise trend",
  "stats.empty": "No data yet",
  "stats.emptyHelp": "Trends and balance appear after your first workout.",
  "stats.consistency": "Consistency",
  "stats.weeklySets": "Working sets per week",
  "stats.monthlySets": "Working sets per month",
  "stats.setChartLabel": "Logged working-set trend",
  "stats.progression": "Progression",
  "stats.byExercise": "By exercise",
  "stats.chooseExercise": "Choose exercise for progression chart",
  "stats.exerciseChartLabel": "Performance trend for the selected exercise",
  "stats.noExerciseData": "No data for this exercise in the selected period.",
  "stats.e1rmHelp": "For external loads the line shows estimated 1RM; bodyweight exercises use the best repetition count.",
  "stats.balance": "Balance",
  "stats.movementBalance": "Movement patterns",
  "stats.balanceHelp": "Compares your working sets across push, pull, legs, core and isolation.",
  "stats.distribution": "Distribution",
  "stats.byMuscle": "Working sets by muscle group",
  "settings.eyebrow": "More",
  "settings.title": "Settings & data",
  "settings.subtitle": "No account, tracking, or cloud storage. All workout data stays locally in this browser.",
  "settings.training": "Training",
  "settings.units": "Unit system",
  "settings.unitsHelp": "Display for external loads",
  "settings.weightStep": "Weight increments",
  "settings.weightStepHelp": "Step size used by the plus and minus buttons",
  "settings.timer": "Rest timer",
  "settings.timerHelp": "Based on each exercise in the plan",
  "settings.source": "Training concept source",
  "settings.sourceDescription": "Original video by Dennis Ratano · conceptual foundation of this training method",
  "settings.sourceLink": "Watch on YouTube",
  "settings.data": "Data",
  "settings.saved": "sessions stored locally",
  "settings.deviceOnly": "IndexedDB · only in this browser",
  "settings.safe": "Local only",
  "settings.exportJson": "Export JSON",
  "settings.importJson": "Import JSON",
  "settings.exportCsv": "Export CSV",
  "settings.importHelp": "Changing devices: export JSON here and import it in the new browser. The backup includes history, paused sessions with drafts and timer, master plan, alternatives, language and unit settings.",
  "settings.confirmImport": "This backup replaces all current local workout and plan data. Continue?",
  "settings.importSuccess": "Backup restored completely.",
  "settings.importError": "The backup is invalid or could not be read.",
